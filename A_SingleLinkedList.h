...
public:
	...
	public:
		...
		/**
		default constructor must be given a node to refrence to begin with
		*/
		...
		*/
		const A_SingleLinkedList_Iterator* Erase(A_SingleLinkedList* const _pos) {
